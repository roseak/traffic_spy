  ...
  class EventTest < Minitest::Test
    ...
    def setup
      ...
      payload1 = { "payload" =>
                   ...
                   "\"2013-01-16 21:38:28 -0700\",\"respondedIn\":37,\""\
      ...
      payload3 = { "payload" =>
                   "{\"url\":\"http://jumpstartlab.com/blog\",\"requestedAt\":"\
                   "\"2013-03-16 21:38:28 -0700\",\"respondedIn\":37,\""\
                   "referredBy\":\"http://jumpstartlab.com\",\"requestType\""\
                   ":\"GET\",\"parameters\":[],\"eventName\": \"boo\",\""\
                   "userAgent\":\"Mozilla/5.0 (Macintosh; Intel Mac OS X "\
                   "10_8_2) AppleWebKit/537.17 (KHTML, like Gecko) Chrome/"\
                   "24.0.1309.0 Safari/537.17\",\"resolutionWidth\":\"1920\""\
                   ",\"resolutionHeight\":\"1280\",\"ip\":\"63.29.38.211\"}",
      ...
      payload4 = { "payload" =>
                   "{\"url\":\"http://jumpstartlab.com/blog\",\"requestedAt\""\
                   ":\"2013-04-16 21:38:28 -0700\",\"respondedIn\":37,\""\
                   "referredBy\":\"http://jumpstartlab.com\",\"requestType\""\
                   ":\"GET\",\"parameters\":[],\"eventName\": \"boo\",\""\
                   "userAgent\":\"Mozilla/5.0 (Macintosh; Intel Mac OS X "\
                   "10_8_2) AppleWebKit/537.17 (KHTML, like Gecko) Chrome/"\
      ...
      payload5 = { "payload" =>
                   "{\"url\":\"http://jumpstartlab.com/image\",\"requestedAt\""\
                   ":\"2013-05-16 21:38:28 -0700\",\"respondedIn\":37,\""\
                   "referredBy\":\"http://jumpstartlab.com\",\"requestType\":"\
                   "\"GET\",\"parameters\":[],\"eventName\": \"boo\",\""\
                   "userAgent\":\"Mozilla/5.0 (Macintosh; Intel Mac OS X "\
                   "10_8_2) AppleWebKit/537.17 (KHTML, like Gecko) Chrome/"\
      ...
      payload6 = { "payload" =>
                   ...
                   "\"2013-01-16 21:38:28 -0700\",\"respondedIn\":37,\""\
                   "referredBy\":\"http://jumpstartlab.com\",\"requestType\":"\
                   "\"GET\",\"parameters\":[],\"eventName\": \"differentEvent"\
                   "\",\"userAgent\":\"Mozilla/5.0 (Macintosh; Intel Mac OS X "\
                   "10_8_2) AppleWebKit/537.17 (KHTML, like Gecko) Chrome/"\
                   "24.0.1309.0 Safari/537.17\",\"resolutionWidth\":\"1920\","\
                   "\"resolutionHeight\":\"1280\",\"ip\":\"63.29.38.211\"}",
