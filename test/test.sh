...
curl -i -d 'payload={"url":"http://yahoo.com/image","requestedAt":"2013-01-14 21:38:28 -0700","respondedIn":23,"referredBy":"http://jumpstartlab.com","requestType":"POST","parameters":["slow"],"eventName": "PartyAtJoshsHouse","userAgent":"Mozilla/3.0 (Macintosh%3B Intel Mac OS X 10_8_2) AppleWebKit/537.17 (KHTML, like Gecko) Chrome/24.0.1309.0 Safari/537.17","resolutionWidth":"800","resolutionHeight":"600","ip":"63.29.38.214"}' http://localhost:9393/sources/yahoo/data

curl -i -d 'payload={"url":"http://yahoo.com/image","requestedAt":"2013-01-14 21:38:28 -0700","respondedIn":45,"referredBy":"http://jumpstartlab.com","requestType":"POST","parameters":["slow"],"eventName": "PartyAtJoshsHouse","userAgent":"Mozilla/3.0 (Macintosh%3B Intel Mac OS X 10_8_2) AppleWebKit/537.17 (KHTML, like Gecko) Chrome/24.0.1309.0 Safari/537.17","resolutionWidth":"800","resolutionHeight":"600","ip":"63.29.38.214"}' http://localhost:9393/sources/yahoo/data

curl -i -d 'payload={"url":"http://yahoo.com/something","requestedAt":"2013-01-14 21:38:28 -0700","respondedIn":77,"referredBy":"http://jumpstartlab.com","requestType":"POST","parameters":["slow"],"eventName": "beginParty","userAgent":"Mozilla/3.0 (Macintosh%3B Intel Mac OS X 10_8_2) AppleWebKit/537.17 (KHTML, like Gecko) Chrome/24.0.1309.0 Safari/537.17","resolutionWidth":"800","resolutionHeight":"600","ip":"63.29.38.214"}' http://localhost:9393/sources/yahoo/data

curl -i -d 'payload={"url":"http://yahoo.com/another","requestedAt":"2013-01-14 21:38:28 -0700","respondedIn":12,"referredBy":"http://jumpstartlab.com","requestType":"POST","parameters":["slow"],"eventName": "beginParty","userAgent":"Mozilla/3.0 (Macintosh%3B Intel Mac OS X 10_8_2) AppleWebKit/537.17 (KHTML, like Gecko) Chrome/24.0.1309.0 Safari/537.17","resolutionWidth":"800","resolutionHeight":"600","ip":"63.29.38.214"}' http://localhost:9393/sources/yahoo/data

curl -i -d 'payload={"url":"http://yahoo.com/blah","requestedAt":"2013-01-14 21:38:28 -0700","respondedIn":123,"referredBy":"http://jumpstartlab.com","requestType":"POST","parameters":["slow"],"eventName": "FallOnYourFace","userAgent":"Mozilla/3.0 (Macintosh%3B Intel Mac OS X 10_8_2) AppleWebKit/537.17 (KHTML, like Gecko) Chrome/24.0.1309.0 Safari/537.17","resolutionWidth":"800","resolutionHeight":"600","ip":"63.29.38.214"}' http://localhost:9393/sources/yahoo/data
